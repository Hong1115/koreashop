<template>
  <div class="hat-list-page">
    <!-- 頁面標題 -->
    <h1 class="page-title">帽子系列</h1>
    
    <!-- 商品網格 -->
    <div class="product-grid-container">
      <div class="product-grid">
        <router-link 
          v-for="product in hatProducts" 
          :key="product.id" 
    ...
    <!-- 如果沒有商品 -->
    <div v-if="hatProducts.length === 0" class="no-products">
      <p>目前沒有帽子商品</p>
...
export default {
  ...
  mounted() {
    // 載入帽子分類的商品
    this.hatProducts = getProductsByCategory('hat');
  }
}
</script>
